...
// Se recibirán por POST los siguientes valores: producto_json (id, codigoBarra,
...
$objSalida->mensaje = "No se ha podido modificar el producto";
...
{
    $productoModificar = new ProductoEnvasado($productoStd->nombre,$productoStd->origen, $productoStd->id,$productoStd->codigoBarra,$productoStd->precio,null);
    $modificado = $productoModificar->Modificar();

    if($modificado)
    {
        $objSalida->exito = true;
        $objSalida->mensaje = "Se ha modificado el producto de la base de datos. ";     
    }
}
