...
namespace PrimerParcial
{
    ...
    // export class Manejadora
    {
        ...
        public EliminarProducto(obj_json:JSON)
        {
        ...
        public ModificarProducto(obj_json:JSON)
        {
        ...
        public BorrarProductoFoto(obj_json:JSON)
        {
            const productoEliminar : any = obj_json;          
        ...
        public ModificarProductoFoto(obj_json:JSON)
        {
                const id: number = parseInt((<HTMLInputElement>document.getElementById('idProducto')).value, 10);
                const nombre: string = (<HTMLInputElement>document.getElementById('nombre')).value;
                const origen: string = (<HTMLInputElement>document.getElementById('cboOrigen')).value;            
                ...
                let productoModificar: Entidades.ProductoEnvasado = new Entidades.ProductoEnvasado(nombre, origen, id, codigoBarra, parseFloat(precio));
