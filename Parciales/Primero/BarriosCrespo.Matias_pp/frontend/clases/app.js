...
(function (PrimerParcial) {
    ...
    var Manejadora = /** @class */ (function () {
        ...
        Manejadora.EliminarProducto = function (obj_json) {
        ...
        Manejadora.ModificarProducto = function (obj_json) {
        ...
        Manejadora.BorrarProductoFoto = function (obj_json) {
            var productoEliminar = obj_json;
            if (confirm("Esta seguro que desea eliminar al producto - Nombre: " + productoEliminar.nombre + " - Origen: " + productoEliminar.codigoBarra)) {
                // Archivo subido por Ajax
        ...
        Manejadora.ModificarProductoFoto = function (obj_json) {
            ...
            // foto
            var file = document.getElementById('foto');
            var productoModificar = new Entidades.ProductoEnvasado(nombre, origen, id, codigoBarra, precio);
            // Archivo subido por Ajax
            var xmlHttp = new XMLHttpRequest();
            var form = new FormData();
